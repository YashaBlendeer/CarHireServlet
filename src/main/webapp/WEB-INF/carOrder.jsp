...
<%--<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/orderHandler.js"></script>--%>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form autocomplete="off" action="/carOrder?carId=${requestScope.carId}"
                ...
                <span class="validation-message" value="${requestScope.dateNotAvailableMessage}"></span>
